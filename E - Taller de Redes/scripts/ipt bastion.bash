...
iptables -A FORWARD -s $redWebPublico -p tcp --dport 80 -j ACCEPT
iptables -A FORWARD -d $redWebPublico -p tcp --sport 80 -j ACCEPT
iptables -A FORWARD -s $redWebPublico -p tcp --dport 443 -j ACCEPT
iptables -A FORWARD -d $redWebPublico -p tcp --sport 443 -j ACCEPT
iptables -A FORWARD -s $redWebPublico -p tcp --dport 53 -j ACCEPT
iptables -A FORWARD -d $redWebPublico -p tcp --sport 53 -j ACCEPT
iptables -A FORWARD -s $redWebPublico -p tcp --dport 20:21 -j ACCEPT
iptables -A FORWARD -d $redWebPublico -p tcp --sport 20:21 -j ACCEPT
