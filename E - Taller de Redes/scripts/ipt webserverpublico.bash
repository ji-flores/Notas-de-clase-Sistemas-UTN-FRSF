...
iptables -A INPUT -i enX0 -s $anywhere -p tcp --dport 80 -m $conexionAny -j ACCEPT
iptables -A OUTPUT -o enX0 -d $anywhere -p tcp --sport 80 -m $conexionEstablished -j ACCEPT